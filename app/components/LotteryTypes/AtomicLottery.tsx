...
import styles from "../../styles/components/AtomicLottery.module.css";
import Image from "next/image";
import atomic from "../../../public/Logo_Atomic.png";
import magnifier from "../../../public/Magnifier_Plusblue.png";
...
const AtomicLottery: React.FC<{ data: any }> = ({ data }) => {
    ...
    <div className={styles.cosmicCard}>
      <div className={styles.topBar}>
        <div className={styles.leftBar}>
          <Image src={atomic} alt={"Cosmic logo"} height={16} width={96} />
          <p className={styles.lightBlueText}>No. {data.roundNumber}</p>
        </div>
